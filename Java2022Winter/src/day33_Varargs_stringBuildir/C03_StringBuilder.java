...
public class C03_StringBuilder {
    public static void main(String[] args) {
        ...
        System.out.println("sb1 length : " + sb1.length()); // sb1 length : 14
        System.out.println("sb1 capacity : " + sb1.capacity()); // sb1 capacity : 16
        ...
        System.out.println("sb1 length : " + sb1.length()); // sb1 length : 19
        System.out.println("sb1 capacity : " + sb1.capacity()); // sb1 capacity : 34

        sb1.append("tum dersler java olsa");
        System.out.println("sb1 length : " + sb1.length()); // sb1 length : 40

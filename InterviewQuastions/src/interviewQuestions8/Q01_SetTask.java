...
// ve tüm karakterleri sete ekleyin
    ...
    public static void main(String[] args) {
        ...
        System.out.println("arrlisti sete attiktan sonra :" +set); // arrlisti sete attiktan sonra :[50, 20, 10, 30]

// Bolum 2
        Set<Character> characterSet=new HashSet<>();
        karakterleriSeteEkle(characterSet,'A','B','R','r','q');
        System.out.println("karakterler sete eklendikten sonra :" +characterSet); // karakterler sete eklendikten sonra :[A, q, B, R, r]

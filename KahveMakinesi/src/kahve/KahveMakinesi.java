...
public class KahveMakinesi {
  ...
  3.Espresso
      ...
      eğer String sut, hayır a eşit ise, konsola , Süt eklenmiyor  yazısı gelsin.
        ...
        Ve konsola   şunu yazdırınız örnek: 5 şeker ekleniyor.
  ...
  String boyut oluşturun...
        ...
        (Türk kahvesi için String hangiKahveyi kullanın.
        orta boy için de String boyut ' u kullanın.)


        todo Açıklama :

       Projeyi bilerek biraz zor hazırladık. Üzerinde fazla fazla kafa yormanız ve
       "grupça çalışmanız için" böyle düzenledik. Yapamayan arkadaşlar kesinlikle canlarını sıkmasın.
       Size çok zor gelebilir. Ancak adım adım ilerlerseniz, grup ile çözerseniz ve yazdığım notları
       tamamen uygularsanız halledebilirsiniz. Öğrenmediğiniz hiçbir şey yok. Sadece biraz karışık.
